...
enum { SchemeNorm, SchemeInv, SchemeSel, SchemeStatus, SchemeTagsSel, SchemeTagsNorm, SchemeInfoSel, SchemeInfoNorm }; /* color schemes */
...
drawbar(Monitor *m)
{
	...
	if ((w = m->ww - tw - x) > bh) {
		...
		//drw_setscheme(drw, scheme[m == selmon ? SchemeInfoSel : SchemeInfoNorm : SchemeInv]);
